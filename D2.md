...
**Alternative Flows: **  
a.  The user names a calendar the same thing as an already existing calendar.  
1. The system alerts the user and prompts them to rename their calendar to a more unique name.   
2. The user enters a new unique name.  
3. The calendar has now been created.
...
**Main Flow: **  
1. User clicks on the hamburger menu icon in the top left of their screen  
2. User taps on “Calendar List” button near the middle of the screen and selects the calendar designated for tracking multiple habits.  
3. The user then clicks on calendar properties located in the hamburger menu.  
4. User clicks add activity to calendar.   
3. The system prompts the user for a name of their activity to be tracked.  
4. User enters the name of the activity and clicks enter.  
