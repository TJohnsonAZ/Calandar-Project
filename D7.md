...
#### 2.2.2 Github Links
[The Class that our test are in](https://github.com/TJohnsonAZ/Calandar-Project/blob/D7_zak/Calandar%20App/app/src/androidTest/java/com/example/calandarapp/TestUserNumber1.java)  


#### 2.2.3 Example test
The test to make sure that the right user is being display:  
```
	    @Rule
...
```
This test runs through the user interface and test to make sure that the user that is displayed on the calendar screen is the same user that was picked on the  
user selection screen.  
[The Test Class](https://github.com/TJohnsonAZ/Calandar-Project/blob/D7_zak/Calandar%20App/app/src/androidTest/java/com/example/calandarapp/TestUserNumber1.java)
